...
import br.com.cadastro.resources.utils.URL;
...
public class ProdutoResource {
	...
	(@RequestParam(value="nome") String nome,
	 ...
	 @RequestParam(value="direction", defaultValue="ASC")String direction ){
		...
		Page<ProdutoDTO> listaDTO;
		Page<Produto> produto = produtoService.search(nome, ids, page, linesPerPage, orderBy,direction);
		listaDTO = produto.map(prod -> new ProdutoDTO(prod));		
